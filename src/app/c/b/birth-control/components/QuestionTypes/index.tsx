//src/app/c/b/birth-control/components/QuestionTypes/index.tsx
      ...
      {question.options.map((option) => (
        <button
          ...
          className={`w-full p-6 text-left rounded-lg border-2 transition-colors ${
            value === option.id
              ? "border-[#01b5de] bg-gray-50" // Updated color scheme
    ...
    <div className="mb-12">
      <input
        ...
        className={`w-full p-6 text-xl rounded-lg border-2 ${
          error ? "border-red-500" : "border-gray-300 focus:border-[#01b5de]" // Updated color scheme
        } focus:outline-none`}
      />
      {error && (

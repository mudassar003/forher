        ...
        <div className="hidden md:flex md:w-1/2 bg-[#fe92b5] relative overflow-hidden">
          ...
          <div className="relative flex flex-col justify-center items-center h-full p-10 text-white z-10">
            ...
            <motion.h1 
              ...
              animate="visible"
            >
              Your Hair Restoration <br />Journey Starts Here
            </motion.h1>
            ...
            <motion.p 
              ...
              animate="visible"
            >
              Personalized treatments backed by medical professionals for effective hair regrowth.
            </motion.p>
          </div>
        </div>
          ...
          <div className="flex-grow overflow-y-auto pb-24 md:pb-0">
            <div className="max-w-lg mx-auto w-full">
              ...
              >
                ...
                >
                  Get Your Personalized Hair Loss Treatment Plan
                </motion.h2>
                ...
                <motion.p 
                  ...
                  variants={staggerItem}
                >
                  Answer questions about your hair loss pattern, medical history, and treatment goals to receive customized recommendations from our hair restoration specialists.
                </motion.p>
                ...
                >
                  ...
                  <div className="flex items-start space-x-3 md:space-x-4">
                    ...
                    <div>
                      <h4 className="font-medium text-gray-800 text-sm md:text-base">Complete a Hair Loss Assessment</h4>
                      <p className="text-gray-600 text-xs md:text-sm">Tell us about your hair loss pattern, family history, and treatment preferences.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3 md:space-x-4">
                    ...
                    <div>
                      <h4 className="font-medium text-gray-800 text-sm md:text-base">Review Treatment Options</h4>
                      <p className="text-gray-600 text-xs md:text-sm">Get personalized hair restoration recommendations based on your specific needs.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3 md:space-x-4">
                    ...
                    <div>
                      <h4 className="font-medium text-gray-800 text-sm md:text-base">Start Your Treatment</h4>
                      <p className="text-gray-600 text-xs md:text-sm">Begin your personalized hair restoration program with expert guidance.</p>
                    </div>
                  </div>
                </motion.div>

  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="prose max-w-none text-gray-700">
        ...
        <p>
          These Terms of Service ("Terms") govern your access to and use of the Direct2Her website, mobile application, and telehealth services (collectively, the "Services"). These Terms constitute a legally binding agreement between you and Direct2Her ("we," "our," or "us"). By accessing or using our Services, you acknowledge that you have read, understood, and agree to be bound by these Terms.
        </p>
        <p>
        ...
        <p>
          TO THE FULLEST EXTENT PERMITTED BY LAW, IN NO EVENT SHALL DIRECT2HER, ITS AFFILIATES, SERVICE PROVIDERS, EMPLOYEES, AGENTS, OFFICERS, OR DIRECTORS BE LIABLE FOR DAMAGES OF ANY KIND, UNDER ANY LEGAL THEORY, ARISING OUT OF OR IN CONNECTION WITH YOUR USE OR INABILITY TO USE OUR SERVICES, ANY WEBSITES LINKED TO THEM, ANY CONTENT ON OUR SERVICES OR SUCH OTHER WEBSITES, INCLUDING ANY DIRECT, INDIRECT, SPECIAL, INCIDENTAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES.
        </p>
        
        <h2 className="text-xl font-semibold mt-8 mb-4">10. Indemnification</h2>
        <p>
          You agree to defend, indemnify, and hold harmless Direct2Her, its affiliates, licensors, and service providers, and its and their respective officers, directors, employees, contractors, agents, licensors, suppliers, successors, and assigns from and against any claims, liabilities, damages, judgments, awards, losses, costs, expenses, or fees (including reasonable attorneys' fees) arising out of or relating to your violation of these Terms or your use of our Services.
        </p>
        ...
        <p>
          These Terms, together with our Privacy Policy, Cookie Policy, and any other agreements expressly incorporated by reference herein, constitute the entire agreement between you and Direct2Her concerning our Services.
        </p>

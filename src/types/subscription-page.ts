  ...
  fields: [
    ...
    defineField({
            ...
            },
            {
              ...
              validation: (Rule) => 
                Rule.custom((currentValue, context) => {
                  const billingPeriod = (context.parent as any)?.billingPeriod;
      ...
      validation: (Rule) => Rule.custom((variants, context) => {
        const hasVariants = (context.document as any)?.hasVariants;
    ...
    defineField({
      ...
      validation: (Rule) => 
        Rule.custom((currentValue, context) => {
          const hasVariants = (context.document as any)?.hasVariants;
          const billingPeriod = (context.document as any)?.billingPeriod;

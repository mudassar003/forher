...
export default function CCPANotice() {
  return (
    ...
    >
      ...
      <ul className="list-disc pl-6 mb-4">
        <li>Email: <a href="mailto:privacy@Lily&apos;s.com" className="text-blue-600 hover:underline">privacy@Lily&apos;s.com</a></li>
      ...
      <div className="bg-blue-50 p-6 rounded-lg border border-blue-100 mt-8 mb-8">
        ...
        <a 
          href="mailto:privacy@Lily&apos;s.com" 

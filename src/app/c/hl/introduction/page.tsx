...
import ProgressBar from "@/app/c/hl/components/ProgressBar"; // We'll create this component
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-white px-6">
      ...
      <div className="max-w-lg text-center mt-10">
        <h2 className="text-3xl font-semibold text-[#6366f1]">Start your hair loss treatment journey.</h2>
